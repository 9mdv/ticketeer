...
class EditConcertTest extends TestCase
{
    ...
    function promoters_can_edit_their_own_unpublished_concerts()
    {
        ...
        $concert = factory(Concert::class)->create([
            ...
            'additional_info' => 'Old additional info',
        ...
        tap($concert->fresh(), function ($concert) {
            ...
            $this->assertEquals('New additional info', $concert->additional_info);
            ...
            $this->assertEquals(8750, $concert->ticket_price);
        });
    }
    ...
    function promoters_cannot_edit_other_unpublished_concerts()
    {
        ...
        tap($concert->fresh(), function ($concert) {
            ...
            $this->assertEquals('Old additional info', $concert->additional_info);
