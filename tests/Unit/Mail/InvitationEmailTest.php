...
class InvitationEmailTest extends TestCase
{
    ...
    function email_contains_a_link_to_accept_the_invitation()
    {
        ...
        $this->assertStringContainsString(url('/invitations/TESTCODE1234'), (string)$email->render());
    }
    /** @test */
    function email_has_the_correct_subject()
    {
        ...
        $this->assertEquals("You're invited to join Ticketeer!", $email->build()->subject);
    }
}
